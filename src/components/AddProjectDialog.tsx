  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-lg bg-neutral-900 p-6 shadow-xl">
        <h2 id="add-project-title" className="mb-4 text-xl font-bold text-neutral-100">
          Add Project
        </h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="add-project-name" className="mb-1 block text-sm text-neutral-400">
              Name
            </label>
            <input
              id="add-project-name"
          ...
          <div>
            <label htmlFor="add-project-path" className="mb-1 block text-sm text-neutral-400">
              Path
            </label>
          ...
          <div>
            <label htmlFor="add-project-description" className="mb-1 block text-sm text-neutral-400">
              Description
            </label>
            <input
